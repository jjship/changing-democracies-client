  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-puprple_lightest_bg">
      <div className="flex w-full flex-1 flex-col justify-center gap-2 px-8 sm:max-w-md">
        <Link
          href="/"
          className="text-foreground group absolute left-8 top-8 flex items-center rounded-md bg-yellow_secondary px-4 py-2 text-sm no-underline hover:bg-red_mains"
        >
          <svg
