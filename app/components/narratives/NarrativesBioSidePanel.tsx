      ...
      >
        <Box className={" self-end "}>
          <Button
            ...
            className={
              "m-8 h-[5vh] w-[5vh] rounded-full border-4 border-green_accent bg-purple_mains p-3 text-2xl font-bold text-green_accent hover:bg-purple_mains"
            }
          >
        ...
        <Box className={"mx-12"}>
          <Box
            className={
              "my-5 w-1/2 border-l-4 border-t-4 border-l-black border-t-black p-5 text-lg font-bold"
            }
          >
