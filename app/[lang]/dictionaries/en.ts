const en = {
  ...
  team: {
    description:
      "Changing Democracies is the result of a collaboration between 12 partners from 10 European countries and is coordinated by the Evens Foundation with funding from the European Commission.",
    teamList: [
      {
      ...
      },
      {
        ...
        members: ["Caroline Coosemans", "Marjolein Delvou", "Hanna Zielińska"],
  ...
  contact: {
    ...
    download:
      "Download our Children and Young People Protection Policy from here.",
  },
  narratives: {
    title: "Narratives",
    select: "select path",
  ...
  freeBrowsing: {
    title: "Free Browsing",
    description:
      "The witnesses who shared their stories with us experienced change either by living through their country's transition in Europe or by moving from a non-democratic country to a democratic one — or sometimes both.",
  ...
  researchPublication: {
    ...
    subtitle:
      "Changing Democracies: the Power of Testimonies for Democratic Education",
