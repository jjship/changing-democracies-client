...
function EventInfo(props: { event: ParsedEventEntry }) {
  ...
  return (
    <div className="overflow-clip leading-5 md:text-[1.375rem] md:leading-[2rem]">
      <p
        className={`h-[4.7rem] text-[1.625rem] font-light uppercase leading-[1.625rem] md:h-max md:max-h-40 md:min-h-[9rem] md:text-[3.375rem] md:font-thin md:leading-[3.3rem] ${textOverflowStyle}`}
      >
        {event.title}
      </p>
